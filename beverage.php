...
<?php
    $sql="select * from recipe where category='beverage'";
    $result=$pdo->query($sql);
    $data=$result->fetchAll();
?>
<section class="bevBnrSec">
    <div class="row">
        <img src="images/beverageBnr.jpg" alt="recipe" class="responsive-img">
    </div>
</section>
...
<div class="row">
    ...
    <div class="col s12 m8">
        ...
        <a href="recipe-child.php?id=<?php echo $value['id']; ?>">
